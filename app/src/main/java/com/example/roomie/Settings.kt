...
class Settings : AppCompatActivity() {
    ...
    val toProfile : Button = findViewById(R.id.back)
    val resetProf : Button = findViewById(R.id.resetProf)
    val resetRoomie : Button = findViewById(R.id.resetRoom)
    val delAccount : Button = findViewById(R.id.delAcc)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resetProf?.setOnClickListener{
            //reset profile
        }

        resetRoomie?.setOnClickListener{
            //reset all roommate pref
        }
